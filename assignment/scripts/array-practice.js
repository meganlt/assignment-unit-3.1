...
let favoriteFoods = ['pizza', 'french silk pie', 'garlic bread', 'spaghetti carbonara', 'kimbap', 'ramen'];
...
console.log('The last animal found by the .length property is:', lastAnimalStretch);
...
let dessert = 'cookie dough ice cream';
favoriteFoods.push(dessert);
console.log('Added a dessert to favorite foods:', favoriteFoods);
...
console.log('Added an entree to favorite foods:', favoriteFoods);
...
let gemToReplace = 'Citrine'
for( i=0; i<gems.length; i++){
  if(gems[i] == gemToReplace){
    gems[i] = 'Tourmaline';
  } else {
    // do nothing
  }
...
console.log('The gems in reverse alphabetical order are:', sortedGems);
...
console.log('The array contains', gemString + '.');
...
console.log('The colorful gems are:', colorfulGems);
